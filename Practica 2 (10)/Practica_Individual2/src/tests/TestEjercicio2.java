...
public class TestEjercicio2 {
	...
	private static List<Trio<BiConsumer<List<Integer>, Integer>, TipoAjuste, String>> metodosComplejidadUmbrales = List.of(
			Trio.of(Ejercicio2::sort, TipoAjuste.NLOGN_0, "Quicksort_50k_u4(complejidad)"), // Análisis de complejidad del algoritmo de ordenación con listas de distintos tamaños y umbral fijo
			Trio.of(Ejercicio2::sort, TipoAjuste.NLOGN_0, "Quicksort_50k_u25(complejidad)"),
			Trio.of(Ejercicio2::sort, TipoAjuste.NLOGN_0, "Quicksort_50k_u100(complejidad)"),
			Trio.of(Ejercicio2::sort, TipoAjuste.NLOGN_0, "Quicksort_50k_u500(complejidad)")
			); 
...
//		generaFicherosTiempoEjecucion(metodosComplejidadUmbrales);
	...
	public static void muestraGraficasDistintosUmbralesQS() {
		List<String> ficherosSalida = List.of("ficheros/TiemposQuicksort_50k_u4(complejidad).csv", 
		...
		List<String> labels = List.of("Umbral 4", "Umbral 25", "Umbral 100", "Umbral 500");
